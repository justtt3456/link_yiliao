...
type SetFunds struct {
	...
	RechargeMinAmount   int64  `gorm:"column:recharge_min_amount"`   //充值最小金额
	RechargeMaxAmount   int64  `gorm:"column:recharge_max_amount"`   //充值最大金额
	...
	WithdrawMinAmount   int64  `gorm:"column:withdraw_min_amount"`   //提现最小金额
	WithdrawMaxAmount   int64  `gorm:"column:withdraw_max_amount"`   //提现最大金额
	WithdrawFee         int    `gorm:"column:withdraw_fee"`          //提现手续费
